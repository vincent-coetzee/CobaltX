...
public class CobaltPackage:Package
    ...
    public func initCobaltPackage() -> Self
        ...
        let dateClass = self.createAndAddValueClass(named:"Date",superclasses: [magnitudeClass])
        let timeClass = self.createAndAddValueClass(named:"Time",superclasses: [magnitudeClass])
        self.createAndAddValueClass(named:"DateTime",superclasses: [dateClass,timeClass])
